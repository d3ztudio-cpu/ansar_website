import{j as h}from"./motion-BfktXgVH.js";import{r as N,L as $e}from"./vendor-DSga0zUN.js";import{L as Ue,K as Ge,n as Be,r as Ve,x as He,_ as Ke,P as qe,Q as Ye,R as he}from"./firebase-CM_HGKg4.js";import{v as Je,a as ze,d as O,u as We,A as Xe}from"./index-d7Fyqo2m.js";var fe="@firebase/ai",ae="2.13.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p extends Ge{constructor(n,s,e){const a=F,i=`${a}/${n}`,o=`${a}: ${s} (${i})`;super(n,o),this.code=n,this.customErrorData=e,Error.captureStackTrace&&Error.captureStackTrace(this,p),Object.setPrototypeOf(this,p.prototype),this.toString=()=>o}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=new Ue("@firebase/vertexai");var _;(function(t){t.UNAVAILABLE="unavailable",t.DOWNLOADABLE="downloadable",t.DOWNLOADING="downloading",t.AVAILABLE="available"})(_||(_={}));/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`):"",K=Xe.map(c=>({...c,...r.find(S=>S.id===c.slug||S.slug===c.slug)||{}})).map(c=>`${c.title}: ${B(c.description,260)}`).join(`
