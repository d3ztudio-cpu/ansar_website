import{n as k,_ as g,p as j,r as nt,t as rt,v as Wt,x as Ht,y as me,z as we,A as Kt,E as ye,B as H,C as K,D as $t,F as qt,L as Gt,G as it,S as z,H as f,I as jt,J as zt,K as Te,M as Bt,N as Jt,O as Yt,P as Le,Q as Me,R as Ue,U as Xt}from"./firebase-CM_HGKg4.js";import{v as Qt}from"./index-d7Fyqo2m.js";function st(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Zt=st,ot=new ye("auth","Firebase",st());/**
 * @license
