import{m as k,_ as g,n as j,p as nt,r as rt,t as Wt,v as Ht,x as me,y as we,z as Kt,E as ye,A as H,B as K,C as $t,D as qt,L as Gt,F as it,S as z,G as f,H as jt,I as zt,J as Te,K as Bt,M as Jt,N as Yt,O as Le,P as Me,Q as Ue,R as Xt}from"./firebase-DIPbNkwp.js";import{w as Qt}from"./index-C6QEyo9r.js";function st(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Zt=st,ot=new ye("auth","Firebase",st());/**
 * @license
